...
- Download or clone the [<span style="color:LightSkyBlue">repo</span>](https://github.com/omar-mohamed/ultimate-image-classification)
...
- Download the dataset from [<span style="color:LightSkyBlue">here</span>](https://drive.google.com/drive/folders/1JaXOQW6MUSE5aSFNv_nQyz45h_WtkoJy?usp=sharing)
